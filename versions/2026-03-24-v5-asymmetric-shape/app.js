const STORAGE_KEY = 'openclaw-vibe-hub-v5-asymmetric-shape-cn-v3';
...
function bindElements() {
  [
    ...
    'settingsToggleBtn','settingsDrawer','closeSettingsBtn','toast','sendProgress','inputTerminalText'
  ].forEach((id) => {
...
function renderCurrentCard() {
  ...
  if (els.inputTerminalText) els.inputTerminalText.textContent = INPUT_TERMINAL;
}
